<x-app-layout>
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="flex items-center justify-between mb-6">
            <div>
                <h1 class="text-xl font-semibold text-gray-900 dark:text-gray-100">Nuevo ingreso</h1>
                <p class="text-sm text-gray-600 dark:text-gray-400">Registrá un ingreso manual.</p>
            </div>
