<x-app-layout>
    <x-slot name="header">
        <span class="text-lg">Nueva subcategoría</span>
    </x-slot>

    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="flex items-center justify-between mb-6">
            <div>
                <h1 class="text-xl font-semibold text-gray-900 dark:text-gray-100">Crear subcategoría</h1>
                <p class="text-sm text-gray-600 dark:text-gray-400">
                    Asociá una subcategoría a una categoría existente.
                </p>
            </div>
        ...
        <div class="rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 shadow-sm">
            <form method="POST" action="{{ route('subcategories.store') }}" class="p-6 space-y-5">
                @csrf
